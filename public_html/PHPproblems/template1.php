...
function processArray($arr) {
    ...
    $odd = ""; //setting up odd array
    foreach($arr as $value){ //set $arr as $value
        if($value%2==1) //checks odd only
        $odd=$odd . "".$value; //sets the values into odd array from $arr
    }
    echo "$odd"; //prints out odd array aka odd numbers only
}
